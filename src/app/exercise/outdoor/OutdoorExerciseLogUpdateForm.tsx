    ...
    <form onSubmit={handleSubmit} className="card rounded-2xl p-6">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex items-center gap-2 sm:col-span-2">
          <input type="checkbox" id="isRoundTripOutdoorEdit" checked={isRoundTrip} onChange={(e) => setIsRoundTrip(e.target.checked)} className="rounded border-[var(--border)]" />
          <label htmlFor="isRoundTripOutdoorEdit" className="text-sm text-[var(--chalk)]">왕복</label>
        </div>
        {isRoundTrip && (
          <div>
